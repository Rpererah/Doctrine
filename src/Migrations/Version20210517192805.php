 ...
 */
final class Version20210517192805 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Curso (id VARCHAR(255) NOT NULL, nome VARCHAR(255) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TABLE curso_aluno (curso_id VARCHAR(255) NOT NULL COLLATE BINARY, aluno_id INTEGER NOT NULL, PRIMARY KEY(curso_id, aluno_id), CONSTRAINT FK_6F96721A87CB4A1F FOREIGN KEY (curso_id) REFERENCES Curso (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6F96721AB2DDF7F4 FOREIGN KEY (aluno_id) REFERENCES Aluno (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__curso_aluno AS SELECT curso_id, aluno_id FROM curso_aluno');
        $this->addSql('DROP TABLE curso_aluno');
        $this->addSql('CREATE TABLE curso_aluno (curso_id VARCHAR(255) NOT NULL, aluno_id INTEGER NOT NULL, PRIMARY KEY(curso_id, aluno_id))');
        $this->addSql('INSERT INTO curso_aluno (curso_id, aluno_id) SELECT curso_id, aluno_id FROM __temp__curso_aluno');
        $this->addSql('DROP TABLE __temp__curso_aluno');
        $this->addSql('CREATE INDEX IDX_6F96721A87CB4A1F ON curso_aluno (curso_id)');
        $this->addSql('CREATE INDEX IDX_6F96721AB2DDF7F4 ON curso_aluno (aluno_id)');
